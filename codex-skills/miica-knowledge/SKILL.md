...
description: Use when the user wants a targeted knowledge base, primer, explainer, onboarding pack, or learning dossier on a bounded topic or workflow. Combines research, source gathering, explanation design, and audience-layered writing to create a dedicated knowledge-base folder.
---

# miica-knowledge

Use this command to create a knowledge base that teaches a bounded topic well.

`miica-se` posture is always on in this kit. Keep the work accurate, teachable, and accessible to mixed audiences.

## Goal

Create a dedicated knowledge base that helps non-technical and technical readers understand the same bounded topic at the right depth.
